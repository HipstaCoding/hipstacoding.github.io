...
Атрибут _(tag attribute)_ - дополнительные свойства HTML елементов. У всех HTML элементов есть общие
аттрибуты и специфические.

Все атрибуты в HTML являются строками.

</section>
<section>

Атрибут **href** _(англ. Hyper REFerence)_ принимает URL адрес ссылки.
