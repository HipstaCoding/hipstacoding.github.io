...
import unit64Html from "./snippets/6-4-unit-context/index.html";
import unit64Css from "./snippets/6-4-unit-context/style.css";
...
Свойство z-index определяет порядок отрисовки компонента
...
<RevealCssEditor html={unit64Html} css3={unit64Css} />
