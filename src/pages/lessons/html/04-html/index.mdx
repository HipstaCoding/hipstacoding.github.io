...
3. [[YouTube] CSS Grid Changes EVERYTHING](https://www.youtube.com/watch?v=7kVeCqQCxlk)
4. [[Habr] CSS Grid Layout. Быстрый старт](https://habr.com/ru/post/325760/)
5. [[CSS Tricks] CSS Grids without media queries](https://css-tricks.com/look-ma-no-media-queries-responsive-layouts-using-css-grid/)
