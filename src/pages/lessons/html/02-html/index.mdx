...
##### После исправления всех ошибок вы запрашиваете ревью еще раз, напарник принимает его:

<ImgContainer width="80%">

![approve pull request](./images/collaboration/10-review-approve.png)
...
![merge branch](./images/collaboration/11-merge.png)
...
![delete branch](./images/collaboration/12-delete.png)
