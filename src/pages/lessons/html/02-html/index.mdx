import altTextPng from "./images/alt-text.png";
import imgResizePng from "./images/image-size.png";
import background from "./images/background.jpg";
import { StackItemContainer } from "components/lessons/reveal";
...
<section>
  <img
    alt="Фотография о любви к редизайну front-end разработчиков и дизайнеров к пользователям"
    src={altTextPng}
    width="612"
    height="556"
  />
...
<StackItemContainer data-fragment-index={1} class="fragment fade-out">
...
<StackItemContainer data-fragment-index={1} class="fragment fade-in-then-out">
...
<StackItemContainer class="fragment fade-in-then-out">
...
<StackItemContainer style={{ minWidth: "806px" }} class="fragment fade-in-then-out">
