      ...
      <Container as="main">
        ...
        <ProfitContainer id="about">
          ...
          <p>
            ...
            разработка собственного персонального webсайта! Это не только
            отличный способ выделяться на фоне остальных кандидатов на
            должность, но и отличный полигон для демонстрации своих
            способностей!
          </p>
          <FeaturesContainer>
